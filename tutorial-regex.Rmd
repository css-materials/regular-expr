...
Welcome! This tutorial will get you started with regular expressions (regex) and the stringr package from the ground up. There are 5 practice exercises. We'll tackle 1–4 together in class and walk through the solutions live. Exercise 5 is bonus practice to try on your own.
...
They describe a specific pattern to match in a given text. More formally, regex is a *language on its own right*  used for *pattern matching* in many programming languages.
...
**PRACTICE 5 SOLUTIONS** Apply regular expressions to "Alice in Wonderland"
